...
class MainWindow(QMainWindow):
    ...
    def print_graph(self):
        ...
        #for i in range(0, 10):
        #    self.csv_list.append(filtering_ch1[240+i])
    ...
    def printFFTGraph(self):
        ...
        ch1_fft = ch1_fft[:60]
        print(ch1_fft[9])
        #self.csv_fft_list = list(ch1_fft)
        ...
        #for z in range(0, 30):
        #    self.csv_fft_list.append(ch1_fft[z])
        #self.ch1_fft_writer.writerow(self.csv_fft_list)
        #self.csv_fft_list = []
