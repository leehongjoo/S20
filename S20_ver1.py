...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.offsetControl = QAction("&OffsetControl", self)
        self.offsetControl.triggered.connect(self.getOffset)
        self.offsetControlPlus = QAction("&OffsetControlPlus", self)
        self.offsetControlPlus.triggered.connect(self.getOffsetPlus)
        ...
        self.bandpass20.triggered.connect(self.bandpass20Button)
        ...
        self.lowPass50 = QAction("S20 : 50 Hz", self)
        ...
        ControlMenu.addAction(self.offsetControl)
        ControlMenu.addAction(self.offsetControlPlus)
    ...
    def getOffsetPlus(self):
        value, ok = QInputDialog.getDouble(self, "input value", "OffsetPlus:", 10, -100, 100, 2)
        if ok:
            self.offsetPlus = value
    ...
    def print_graph(self):
        ...
        for a in range(10):
            self.dataIndex += 1
            ch1_int = filtering_ch1[-self.update_num + a]
            ch2_int = filtering_ch2[-self.update_num + a]
